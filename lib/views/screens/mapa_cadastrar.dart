                                      ...
                                      child: ListView(
                                        ...
                                        children: [
                                          ...
                                          _buildInfoCard(
                                            ...
                                            children: [
                                              _buildInfoRow(context, 'Endereço', 'Asa Norte SQN 410'),
                                              _buildInfoRow(context, 'Telefone', '(61) 3321-8181'),
                                            ],
                                          ),
                                          ...
                                          _buildInfoCard(
                                            ...
                                            children: [
                                              _buildInfoRow(context, 'Classificação', 'Edificado'),
                                              _buildInfoRow(context, 'Ponto Oficial', 'Sim'),
                                              _buildInfoRow(context, 'Nº de Vagas', '4'),
                                            ],
                                          ),
                                          const SizedBox(height: 16),
                                          _buildInfoCard(
                                            ...
                                            children: [
                                              _buildChipRow(context, [
                                                _buildStatusChip('Sinalização', true),
                                                _buildStatusChip('Abrigo', true),
                                              ]),
                                              const SizedBox(height: 8),
                                              _buildChipRow(context, [
                                                _buildStatusChip('Energia', true),
                                          ...
                                          _buildInfoCard(
                                            ...
                                            children: [
                                              _buildInfoRow(context, 'Autorizatário', 'Maria Santos - Num 002'),
                                            ],
                                          ),
                                          const SizedBox(height: 16),
                                          _buildInfoCard(
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(
                                                color: modoApp.isCadastro ? Colors.green.shade200 : Colors.grey.shade300,
                                                width: 1,
                                              ),
                                            ),
                                            child: TextButton(
                                                onPressed: ()=> Navigator.push(context,
                                                    MaterialPageRoute(builder: (context) => DetalhamentoEdicaoPonto())),
                                                child:
                                                  Text('Mais Detalhes', style: TextStyle(fontSize: 18, color: Colors.green[900]),)),
                                          ),
                                          SizedBox(height: (AppConstants.navigationBarAltura + 36),)
                                        ],
                                      ),
                                    ),
                                  ],
